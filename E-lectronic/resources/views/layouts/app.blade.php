            ...
            <section>
                <div class="monCompteEcom  row">
                    ...
                    <div class="mon-Compte col-lg-8">
                        <br/>
                        <p>
                            Bonjour <strong>{{ Auth::user()->name }}</strong> (vous n’êtes pas
                            <strong>{{ Auth::user()->name }})</strong> ?
                        </p>
                        <br>
                        <p>
                            À partir du tableau de bord de votre compte, vous pouvez visualiser vos
                            <a href="{{ route('commande') }}">commandes récentes</a>, gérer vos <a href="{{ route('adresse') }}">adresses de livraison et de
                                facturation</a>
                            ainsi que <a href="{{ route('profile.show') }}">changer votre mot de passe et les détails de votre compte</a>.
                        </p>
                    </div>
                </div>
            </section>
