...
<head>
    <meta charset="UTF-8" />
    <title>Commandes | E-lectronic</title>
                                ...
                                <div class="cart">
                                    <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                        ...
                                        <div class="cart_content">
                                            <div class="cart_text"><a href="{{ route('afficherPanier') }}">Panier</a>
                                            </div>
            ...
            <section>
                <div class="monCompteEcom  row">
                    <div class="monCompte col-lg-4 d-flex">
                        <nav>
                            <li class="monCompte-navigation-link"><a href="{{ route('dashboard') }}">Tableau de bord</a></li>
                            <li class="monCompte-navigation-link" style="background-color: #fbfbfb"><a style="color:black;" href="{{ route('commande') }}">Commandes</a></li>
                            <li class="monCompte-navigation-link"><a href="{{ route('adresse') }}">Adresses</a></li>
                            <li class="monCompte-navigation-link"><a href="{{ route('profile.show') }}">Détails du compte</a></li>
                    ...
                    <div class = "mon-Compte col-lg-8">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    <td>{{ 'n°'. $i++ }}</td>
                                    <td>{{ $commande->payment_created_at }}</td>
                                    <td>@foreach (  unserialize($commande->articles)  as $com)
                                        {{ $com[0] }} <br/>
                                    @endforeach</td>
                                    <td>{{ $commande->amount .' Dhs'}}</td>
                                </tr>
                               @endforeach
                               @else
                               @endif
