...
<head>
  <meta charset="UTF-8"/>
  <title>Cartes électroniques | E-lectronic</title>
    ...
    <div class="container rayon_produit_style" id="Kits">
		...
		@foreach($articles as $article)
					@if( $article->Categorie === "Carte")
						...
						<a href="{{ route('voirArticle',['refArticle'=>$article->refArticle]) }}"><img src="{{ asset('storage/'.$article->Images.'/new.JPG') }}" class="card-img-top" alt="..."></a>
						<div class="card-body">
