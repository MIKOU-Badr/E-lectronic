            ...
            <section>
                <div class="monCompteEcom  row">
                    <div class="monCompte col-lg-4 d-flex">
                        <nav>
                            ...
                            <li class="monCompte-navigation-link" style="background-color: #fbfbfb"><a
                               href="{{ route('adresse') }}" style="color:black;">Adresses</a></li>
                    ...
                    <div class="mon-Compte col-lg-8">
                        <p>
                            Votre adresse de livraison actuelle est : <FONT color="#0e8ce4">{{ Auth::user()->Adresse }}</FONT>
                            <br>Voulez-vous la modifié ?
                            <form action="{{ route('updateAdresse') }}" method="GET">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="adresse" id="adresse" placeholder="Ville, Quartier, et Rue">
