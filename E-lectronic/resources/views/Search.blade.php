<!DOCTYPE html>
<head>
<title>Résultats de recherche | E-lectronic</title>
<meta charset="utf-8">
...
<link rel="stylesheet" type="text/css" href="<?php echo url('/'); ?>/plugins/slick-1.8.0/slick.css">
<link href="https://fonts.googleapis.com/css?family=Roboto:400,700" rel="stylesheet">
<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="<?php echo url('/'); ?>/styles/product_styles.css">
<link rel="stylesheet" type="text/css" href="<?php echo url('/'); ?>/styles/button_styles.css">
<link rel="stylesheet" type="text/css" href="<?php echo url('/'); ?>/styles/product_responsive.css">
...
<body>
    ...
    <div class="container-fluid">
        <nav class="compte">
            <ul>
                ...
                <li class="compte_li">
                    <a href="#">Résultats de Recherche</a>
                </li>
            </ul>
        </nav>
    </div>
	...
	@endif
    @if(request()->input())
        <div class="container rayon_produit_style">
            <h6>{{ $articles->total()}} Résultats pour la recherche "{{ request()->q }}"</h6>
            <div class="row">
            @foreach($articles as $article)
                <div class="card col-6 col-md-4 col-lg-3">
                    <a href="{{ route('voirArticle',['refArticle'=>$article->refArticle]) }}"><img src="{{ asset('storage/'.$article->Images.'/image_1.JPG') }}" class="card-img-top" alt="..."></a>
                    <div class="card-body">
